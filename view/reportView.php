			...
			<div class="row">
				<div class="span12">
					...
					<form action="" method="post">
						<input type="hidden" name="action" value="buildCache">						
						<button type="submit" class="btn btn-warning btn-mini" data-loading-text="Updating..."><i class="icon-refresh icon-white"></i>&nbsp;Rebuild Cache</button>
					</form>
				</div>
			</div>
			<div class="row">
